...
class Utils {
    ...
    public static function validaCpf($num) {
        ...
        return strlen($num) == 11 && self::mod($num, 9) && self::mod($num, 10);
    }
    ...
    public static function validaCnpj($num) {
        ...
        return strlen($num) == 14 && self::mod($num, 12, true) && self::mod($num, 13, true);
    }
    ...
    public static function formatarPLACA( $string ){
        if( !empty($string) ){
            return substr($string, 0,3) .'-'. substr($string, 3, strlen($string));
        }
        return $string;
    }
